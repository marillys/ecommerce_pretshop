...
public class PedidoPage {
	...
	{
		String valor =driver.findElement(totalProdutos).getText();
		return Funcoes.removeCifraoDevolveDouble(valor);
	}
	
	public Double obter_totalTaxIncl() 
	{
		String valor =driver.findElement(totalTaxIncl).getText();
		return Funcoes.removeCifraoDevolveDouble(valor);
	}
